...
def search_properties(prop_details):
    ...
    url = 'https://api.zoopla.co.uk/api/v1/property_listings.js?api_key=xzphw4h23gkpmrsmxdze2wjk&' + query_string
    print(url)
...
def get_local_nbrhood_details(prop_details):
    ...
    url = 'https://api.zoopla.co.uk/api/v1/property_listings.js?api_key=xzphw4h23gkpmrsmxdze2wjk&' + \
    ...
    query_string = '&'.join('{}={}'.format(key, value)
                            for key, value in query_json.items())
    query_string = query_string.replace(' ', '%20')
    url = 'https://api.zoopla.co.uk/api/v1/average_area_sold_price.js?api_key=xzphw4h23gkpmrsmxdze2wjk&' + query_string
    average_area_sold_price = requests.get(url).json()
    url = 'https://api.zoopla.co.uk/api/v1/local_info_graphs.js?api_key=xzphw4h23gkpmrsmxdze2wjk&' + query_string
    local_info_graphs = requests.get(url).json()
    url = 'https://api.zoopla.co.uk/api/v1/area_value_graphs.js?api_key=xzphw4h23gkpmrsmxdze2wjk&' + query_string
